...
export type AgentSSEEvent = {
  event: 'tool' | 'step' | 'message' | 'stream' | 'error' | 'done' | 'title' | 'wait' | 'plan' | 'attachments';
  data: ToolEventData | StepEventData | MessageEventData | StreamEventData | ErrorEventData | DoneEventData | TitleEventData | WaitEventData | PlanEventData;
}
